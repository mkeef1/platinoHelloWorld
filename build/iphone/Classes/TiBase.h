...
// in simulator we redefine to format for intro Developer console
...
{\
	NSString * exceptionName = [@"org.intro." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.intro";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIintroNativeItemNone = -1, 
	UIintroNativeItemSpinner = -2,
	UIintroNativeItemProgressBar = -3,
	
	UIintroNativeItemSlider = -4,
	UIintroNativeItemSwitch = -5,
	UIintroNativeItemMultiButton = -6,
	UIintroNativeItemSegmented = -7,
	
	UIintroNativeItemTextView = -8,
	UIintroNativeItemTextField = -9,
	UIintroNativeItemSearchBar = -10,
	
	UIintroNativeItemPicker = -11,
	UIintroNativeItemDatePicker = -12,
	
	UIintroNativeItemInfoLight = -13,
	UIintroNativeItemInfoDark = -14,
	
	UIintroNativeItemDisclosure = -15,
	
	UIintroNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all intro instances of
