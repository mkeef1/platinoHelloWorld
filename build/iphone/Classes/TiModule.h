...
/**
 The base class for all intro modules
 */
...
/**
 intro Platform calls this method on startup.
 */
-(void)startup;

/**
 intro Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 intro Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 intro Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 intro Platform calls this method on resume.
 @param sender The sender of the event.
 */
